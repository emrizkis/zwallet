 ...
 * Use the [SuccessTransactionFragment.newInstance] factory method to
...
class SuccessTransactionFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment SuccessTransactionFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            SuccessTransactionFragment().apply {
